...
// Constructor ----------------------------------------------------------------
TcpSocket::TcpSocket(const char *port) : port(port), sd(NULL_SD)
{
...
bool TcpSocket::setDestAddress(const char *ipName)
{
...
int TcpSocket::sendTo(char msg[], int length)
{
...
int TcpSocket::recvFrom(char msg[], int length)
{
...
int TcpSocket::ackTo(char msg[], int length)
{
